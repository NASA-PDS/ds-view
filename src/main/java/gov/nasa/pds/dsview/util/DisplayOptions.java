...
public class DisplayOptions {
  public static String getMultiValues(HttpServletRequest request, String keyword, String param,
      String selected) {
  ...
  public static String displayValList(HttpServletRequest request, String keyword, String param,
      String[][] valList) {
    ...
    defaultVal[0] = "All";
    String[] selectedVal =
        (request.getParameterValues(formParam) != null ? request.getParameterValues(formParam)
            : defaultVal);
    for (int i = 0; i < valList.length; i++) {
      ...
      options.append("value=\"").append(valList[i][1].trim()).append("\">")
          .append(valList[i][0].trim()).append("\n");
    }
    if (options.length() > 0) {
      options.append("</option>");
    }
  ...
  public static String displayValList(HttpServletRequest request, String keyword, String param,
    ...
    for (int i = 0; i < valList.length; i++) {
      ...
      options.append("value=\"").append(valList[i].trim()).append("\">").append(valList[i].trim())
          .append("\n");
    }
    if (options.length() > 0) {
      options.append("</option>");
  ...
  public static String displayInput(HttpServletRequest request, String keyword, String param,
      String defaultVal) {
    String formParam = "";
    if (request.getParameterValues(param) != null) {
      formParam = param;
    ...
    return (request.getParameterValues(formParam) != null ? request.getParameterValues(formParam)[0]
        : defaultVal);
  }

  public static String CapFirstLetter(String instring) {
    StringTokenizer st = new StringTokenizer(instring.toLowerCase(), " .,/-():[]{}\"'", true);
